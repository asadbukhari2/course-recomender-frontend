        ...
        <Aux>
            ...
            <div className={attachedClasses.join(' ')}>
                ...
                <h3 className={classes.SideDrawerClose}>
                    <div
                        className={classes.SideDrawerCloseDiv}
                ...
                <div className={classes.Controller}>
                    <div className={classes.Select}>
                        ...
                        <div className={classes.SubmitButton} onClick={toggleCategoryFilterHandler}>
                            <NavLink
                                to={'courses'}
                            >
                    ...
                    <div className={classes.Select}>
                        ...
                        <div className={classes.SubmitButton} onClick={toggleDifficultyFilterHandler}>
                            <NavLink
                                to={'courses'}
                            >
                                <Button btnType={'ButtonGhost'}>
