		...
		const actions =
			{
				...
				TOGGLE_DEGREE_SEMESTER:
					(
						...
						currState.course.degree =
							data.degree;
						currState.course.semester =
							data.semester;
				...
				FILTERED_COURSES:
					currState => {
						...
						currState.course.filterItem =
							currState.course.courses.filter(
								filterCourses =>
									filterCourses.study_mode ===
										currState
											.course
											.study_mode &&
									filterCourses.degree ===
										currState
											.course
											.degree &&
